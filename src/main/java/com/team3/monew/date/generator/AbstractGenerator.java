...
/**
 * 1. 이 클래스를 상속받아 T(엔티티)를 지정합니다. 2. getModel(): Instancio를 사용하여 엔티티 필드 생성 규칙을 정의합니다. 3. getSql():
 * JDBC용 INSERT 쿼리를 작성합니다. 4. setValues(): PreparedStatement에 엔티티 값을 매핑합니다.
 * <p>
 * 그외 -
 *
 * @Profile("data-gen")을 구현 클래스에 붙여주세요. - @Qualifier("dataGeneratorExecutor")를 생성자에 주입받아야 합니다. - 성능을
 * 위해 JDBC batchUpdate를 사용합니다.
 */
